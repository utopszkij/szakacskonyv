...
A hozzászólások mindenki számára láthatóak">
	...
	<link rel="stylesheet" href="<?php echo SITEURL; ?>/styles/default/admin.css?t=<?php echo $fileVerzio; ?>" />
	<link rel="stylesheet" href="<?php echo SITEURL; ?>/styles/default/style.css?v=<?php echo $fileVerzio; ?>" />
	<!-- multi language -->
	<?php
		if (defined('LNG')) {
